...
export async function createHistoricoWorkbook(orcamentos: Orcamento[]): Promise<ExcelJS.Workbook> {
  ...
  sheet.columns = [
    ...
    { header: 'Cliente cadastrado', key: 'clienteNome', width: 32 },
    { header: 'Documento', key: 'clienteDocumento', width: 20 },
    { header: 'Representante', key: 'representanteNome', width: 24 },
  ...
  orcamentos.forEach((orcamento) => {
    sheet.addRow({
      ...
      representanteNome: orcamento.representanteNome ?? '',
